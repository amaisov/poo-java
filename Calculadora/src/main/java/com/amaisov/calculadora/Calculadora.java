...
public class Calculadora {
    ...
    public static void main(String[] args) {
        ...
        switch(operacion) {
            ...
            case 2:
                resta(num1, num2);
                System.out.println(" Has seleccionado operaccion 2 ");
                break;
            case 3:
                producto(num1, num2);
                System.out.println(" Has seleccionado operaccion 3 ");
                break;
            case 4:
                division(num1, num2);
                System.out.println(" Has seleccionado operaccion 4" );
                break;
            case 5:
                modulo(num1, num2);
                ...
                break;
            case 6:
                System.out.println(" Has seleccionado operaccion 6 ");
                System.exit(1);
            default:
